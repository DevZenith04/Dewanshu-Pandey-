window.ZameenData = {};
window.ZameenData.initialNationalStats = {
...
window.ZameenData.initialParcels = [
  {
    "id": "PRC-2023-884A",
...
window.ZameenData.initialProjects = [
  {
    ...
    "shapFactors": [
      {
        "driver": "Unresolved Multi-heir Titles",
        "vector": "up",
        "impact": 24.5
      },
      {
        "driver": "Proximity to Urban Agglomeration",
        "vector": "up",
        "impact": 18.2
      },
      {
        "driver": "Previous Litigation History on Parcel",
        "vector": "up",
        "impact": 12
      },
      {
        "driver": "Community Consultation Record",
        "vector": "down",
        "impact": -8.5
      }
    ],
    ...
    "milestones": [
      {
        ...
        "entryType": "SECTION_11_ISSUED",
        "description": "Official notification under Section 11 gazetted in district records.",
        "refNo": "SEC-11-99",
        "tagType": "GAZETTE"
      },
      {
        "timestamp": "2024-02-01 09:00",
        "entryType": "OBJECTION_REGISTERED",
        "description": "Multi-heir title objection petition received from 12 landowners.",
        "refNo": "OBJ-442",
        "tagType": "JUDICIAL STAY"
      },
      {
        "timestamp": "2024-01-15 14:00",
        "entryType": "INITIAL_FILING",
        "description": "Project scope and cadastral maps submitted to ADM registry.",
        "refNo": "IN-2024-X9F",
    ...
    "riskPredictionBreakdown": [
      {
        "factor": "MULTI-HEIR TITLE CONFLICT",
        "score": 92,
        "level": "critical",
        "description": "High probability of court stay due to undivided heir rights."
      },
      {
        "factor": "URBAN PROXIMITY INDEX",
        "score": 78,
        "level": "warning",
        "description": "Inflated commercial land compensation claims."
      },
      {
        "factor": "ENVIRONMENTAL CLEARANCE",
        "score": 15,
        "level": "low",
        "description": "Non-forest land type, minimal clearance bottleneck."
      }
    ]
  },
  {
    ...
    "shapFactors": [
      {
        "driver": "Judicial Stay on Flood Plain Alteration",
        "vector": "up",
        "impact": 32.1
      },
      {
        "driver": "Public Protest & NGO Mobilization",
        "vector": "up",
        "impact": 21.4
      },
      {
        "driver": "Ecological Buffer Clearance",
        "vector": "up",
        "impact": 15
      },
      {
        "driver": "Survey Demarcation Verification",
        "vector": "down",
        "impact": -6.2
      }
    ],
    "directives": [
      {
        "id": "k9-1",
        "title": "Engage State Legal Panel",
        "description": "Prepare counter-affidavit against High Court stay order regarding zoning.",
        "completed": false
      },
      {
        "id": "k9-2",
        "title": "Commission Environmental Impact Assessment",
        "description": "Submit updated flood plain survey by independent accredited contractor.",
        "completed": true
      }
    ],
    "milestones": [
      {
        ...
        "entryType": "JUDICIAL STAY",
        "description": "High Court order suspending zoning alteration pending environmental review.",
        "refNo": "HC-23-A9",
        "tagType": "JUDICIAL STAY"
      },
      {
        "timestamp": "2023-10-05 09:15",
        "entryType": "SURVEY_UPDATE",
        "description": "Topographical reassessment submitted by independent contractor.",
        "refNo": "SV-88-B2",
        "tagType": "SURVEY_UPDATE"
      },
      {
        "timestamp": "2023-08-22 11:00",
        "entryType": "PUBLIC_HEARING",
        "description": "Minutes filed from local municipal council review session.",
        "refNo": "PH-44-C1",
        "tagType": "PUBLIC_HEARING"
      },
      {
        "timestamp": "2023-01-14 16:45",
        "entryType": "INITIAL_FILING",
        "description": "Original project demarcation proposal entered into registry.",
        "refNo": "IN-01-AA",
        "tagType": "INITIAL_FILING"
      }
    ],
    "riskPredictionBreakdown": [
      {
        "factor": "JUDICIAL STAY PROBABILITY",
        "score": 88,
        "level": "critical",
        "description": "High correlation with recent supreme court rulings on floodplain construction."
      },
      {
        "factor": "PUBLIC PROTEST INDEX",
        "score": 64,
        "level": "warning",
        "description": "Elevated sentiment analyzing local news and NGO activity in the region."
      },
      {
        "factor": "BOUNDARY DISPUTE",
        "score": 12,
        "level": "low",
        "description": "Adjacent parcels clearly demarcated; historical ledger aligns."
      }
    ]
  },
  {
    ...
    "shapFactors": [
      {
        "driver": "Clear Title Records",
        "vector": "down",
        "impact": -14.2
      },
      {
        "driver": "High Farmer Consensus",
        "vector": "down",
        "impact": -10.5
      }
    ],
    "directives": [
      {
        "id": "dir-09a-1",
        "title": "Complete Drone Boundary Mapping",
        "description": "Finalize high-resolution aerial cadastral verification.",
        "completed": true
      }
    ],
    "milestones": [
      {
        "timestamp": "2023-09-10 10:00",
        "entryType": "PRELIMINARY_SURVEY",
        "description": "Initial drone survey completed across 1250 hectares.",
        "refNo": "SV-09A-1",
        "tagType": "SURVEY_UPDATE"
      }
    ],
    "riskPredictionBreakdown": [
      {
        ...
        "score": 12,
        "level": "low",
        "description": "Records match state revenue portal."
      }
    ]
  },
  {
    ...
    "shapFactors": [
      {
        "driver": "Wetland Protection Law Suit",
        "vector": "up",
        "impact": 28.4
      },
      {
        "driver": "Encroachment Verification Delay",
        "vector": "up",
        "impact": 14.1
      }
    ],
    "directives": [
      {
        "id": "dir-14c-1",
        "title": "Environmental Advisory Consult",
        "description": "Appoint wetlands conservation panel to evaluate buffer zone.",
        "completed": false
      }
    ],
    "milestones": [
      {
        "timestamp": "2023-08-14 11:00",
        "entryType": "ECOLOGICAL_NOTICE",
        "description": "Notice issued regarding buffer zone encroachment.",
        "refNo": "EC-14C",
        "tagType": "JUDICIAL STAY"
      }
    ],
    "riskPredictionBreakdown": [
      {
        "factor": "ECOLOGICAL DISPUTE",
        "score": 84,
        "level": "critical",
        "description": "Active petition in National Green Tribunal."
      }
    ]
  },
  {
    ...
    "shapFactors": [
      {
        "driver": "Commercial Compensation Disputes",
        "vector": "up",
        "impact": 12.3
      },
      {
        "driver": "Strong Inter-Agency Alignment",
        "vector": "down",
        "impact": -8.1
      }
    ],
    "directives": [
      {
        "id": "dir-42x-1",
        "title": "Finalize Commercial Rates",
        "description": "Publish updated circle rates for mixed-use plots.",
        "completed": true
      }
    ],
    "milestones": [
      {
        ...
        "entryType": "VALUATION_REPORT",
        "description": "Commercial land valuation report finalized.",
        "refNo": "VAL-42X",
        "tagType": "PUBLIC_HEARING"
      }
    ],
    "riskPredictionBreakdown": [
      {
        ...
        "score": 45,
        "level": "warning",
        "description": "Minor disagreement on commercial valuation multipliers."
      }
    ]
  },
  {
    ...
    "shapFactors": [
      {
        "driver": "Large Scale Displacement Resistance",
        "vector": "up",
        "impact": 29.8
      },
      {
        "driver": "Historical District Delay Rate",
        "vector": "up",
        "impact": 19.5
      }
    ],
    "directives": [
      {
        "id": "dir-88b-1",
        "title": "Establish R&R Special Task Force",
        "description": "Set up dedicated desk for 520 affected industrial families.",
        "completed": false
      }
    ],
    "milestones": [
      {
        ...
        "entryType": "INITIAL_NOTIFICATION",
        "description": "Public notice published in regional daily gazette.",
        "refNo": "GAZ-88B",
        "tagType": "INITIAL_FILING"
      }
    ],
    "riskPredictionBreakdown": [
      {
        ...
        "score": 92,
        "level": "critical",
        "description": "High displacement count requires multi-agency R&R intervention."
      }
    ]
  },
  {
    ...
    "shapFactors": [
      {
        "driver": "Encroachment along ROW",
        "vector": "up",
        "impact": 26.2
      },
      {
        "driver": "Pending High Court Writ",
        "vector": "up",
        "impact": 18.9
      }
    ],
    "directives": [
      {
        "id": "dir-884-1",
        "title": "Expedite High Court Bench Hearing",
        "description": "File urgent listing petition for Plot B-42 ROW clearance.",
        "completed": false
      }
    ],
    "milestones": [
      {
        ...
        "entryType": "ROW_INSPECTION",
        "description": "Right of way survey recorded 14 illegal commercial structures.",
        "refNo": "ROW-884",
        "tagType": "SURVEY_UPDATE"
      }
    ],
    "riskPredictionBreakdown": [
      {
        "factor": "ROW CLEARANCE",
        "score": 94,
        "level": "critical",
        "description": "Critical bottleneck due to commercial structure encroachments."
      }
    ]
  },
  {
    ...
    "shapFactors": [
      {
        "driver": "Catchment Area Soil Stability",
        "vector": "up",
        "impact": 16.4
      }
    ],
    "directives": [
      {
        ...
        "description": "Complete deep core testing for reservoir boundary.",
        "completed": false
      }
    ],
    "milestones": [],
    "riskPredictionBreakdown": [
      {
        "factor": "GEOTECHNICAL CLEARANCE",
        "score": 68,
        "level": "warning",
        "description": "Pending clearance from State Water Board."
      }
    ]
  },
  {
    ...
    "shapFactors": [
      {
        "driver": "Underground Gas Line Relocation",
        "vector": "up",
        "impact": 14.8
      }
    ],
    "directives": [
      {
        "id": "dir-751-1",
        "title": "Joint Inter-Agency Utility Map",
        "description": "Coordinate with GAIL and BESCOM for pipeline diversion.",
        "completed": true
      }
    ],
    "milestones": [],
    "riskPredictionBreakdown": [
      {
        ...
        "score": 61,
        "level": "warning",
        "description": "Inter-agency coordination delay for high-pressure gas line."
      }
    ]
  },
  {
    ...
    "shapFactors": [
      {
        "driver": "Unencumbered Government Land",
        "vector": "down",
        "impact": -18
      }
    ],
    "directives": [
      {
        "id": "dir-633-1",
        "title": "Monitor Excavation Milestone",
        "description": "Quarterly review on site foundation progress.",
        "completed": true
      }
    ],
    "milestones": [],
    "riskPredictionBreakdown": [
      {
        "factor": "LAND CLEARANCE",
        "score": 14,
        "level": "low",
        "description": "Full possession handed over without encumbrance."
      }
    ]
  }
];
